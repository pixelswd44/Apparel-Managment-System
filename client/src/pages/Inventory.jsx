...
import {
  ...
  ArrowUpCircle, Search, RefreshCw,
} from 'lucide-react';
...
function ItemDetail({ item, onEdit, onStockIn, onDelete }) {
      ...
      <div className="grid grid-cols-3 border-b border-slate-100">
        {[
          ...
          <div key={label} className="px-4 py-4 text-center border-r border-slate-100 last:border-0">
            ...
            <p className="text-xs text-slate-500 mt-0.5 font-medium">{pkr(value * item.rate)}</p>
          </div>
        ))}
      </div>
